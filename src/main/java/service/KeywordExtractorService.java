...
public class KeywordExtractorService {
    ...
    public Set<String> extractKeywords(String inputText){
        ...
        return keywords.stream().map(String::toLowerCase).collect(Collectors.toSet());
    }
    ...
    private void extractKeywordsFromPartsOfSpeech(String[] tokens, String[] posTags, List<String> stopWords,
                                                  Set<String> keywords) {
